...
public class FragQuote13 extends Fragment{
    ...
    {
        View view = inflater.inflate(R.layout.fragment_frag_quote13, container, false);
                ...
                database.getReference("Fav").child(name.getText().toString()).addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        else
                        {
                            ...
                            fav.setText("Remove");
                            database.getReference().child("Fav").child(name.getText().toString()).setValue(new RCModel(R.drawable.aquman,name.getText().toString(),quote.getText().toString()));
