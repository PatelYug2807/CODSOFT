...
public class FragQuote6 extends Fragment{
    ...
    {
        View view = inflater.inflate(R.layout.fragment_frag_quote6, container, false);
        ...
        fav.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                if(count==0)
                {
                    ...
                    fav.setText("Remove");
                    database.getReference().child("Fav").child(name.getText().toString()).setValue(new RCModel(R.drawable.spiderman,name.getText().toString(),quote.getText().toString()));
                    count++;
                }
                //Removing from Fav
                else
